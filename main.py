...
# MBTI별 직업, 설명, 이미지 URL, 유튜브 링크를 포함한 데이터 구조
mbti_jobs = {
    "INTJ 🧠✨": {
        "데이터 과학자 📊": {
            "desc": "복잡한 데이터를 분석하여 전략을 수립하는 전문가예요. 논리적인 사고를 좋아하는 INTJ에게 딱이에요!",
            "img": "https://images.unsplash.com/photo-1556157382-97eda2d62296?auto=format&fit=crop&w=800&q=60",  # 예시 이미지 URL
            "video": "https://www.youtube.com/watch?v=ua-CiDNNj30"  # 데이터 과학 입문 유튜브
        },
        "AI 연구원 🤖": {
            "desc": "인공지능의 미래를 여는 연구자. 끊임없이 새로운 지식을 탐구하는 성향과 잘 맞아요!",
            "img": "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=800&q=60",
            "video": "https://www.youtube.com/watch?v=JMUxmLyrhSk"  # AI 개념 설명 영상
        },
        "전략 컨설턴트 📈": {
            "desc": "기업의 문제를 해결해주는 전략가. 분석력과 계획력을 가진 INTJ에게 적합해요.",
            "img": "https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=800&q=60",
            "video": "https://www.youtube.com/watch?v=w1B6U-N0xD4"  # 전략 컨설팅 소개
        },
    },
    "INFP 🌸🎨": {
        "작가 ✍️": {
            "desc": "감성을 글로 풀어내는 직업. 자기 표현을 중요시하는 INFP에게 잘 어울려요.",
            "img": "https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=800&q=60",
            "video": "https://www.youtube.com/watch?v=YXWwYLUl8RQ"  # 작가 되는 법
        },
        "심리상담사 🧘": {
            "desc": "사람의 마음을 이해하고 돕는 역할. 공감 능력이 뛰어난 INFP에게 추천해요.",
            "img": "https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&w=800&q=60",
            "video": "https://www.youtube.com/watch?v=2nQZp7Iuhx8"  # 심리상담사 직업 설명
        },
        "예술가 🎭": {
            "desc": "자신의 감정을 예술로 표현해요. 창의성과 감수성이 풍부한 INFP에게 제격이에요.",
            "img": "https://images.unsplash.com/photo-1511765224389-37f0e77cf0eb?auto=format&fit=crop&w=800&q=60",
            "video": "https://www.youtube.com/watch?v=8w4bCzTCjsI"  # 예술가 인터뷰 영상
        },
    },
    # 다른 MBTI 직업도 추가 가능
}
...
if mbti_selected:
    ...
    for job, info in mbti_jobs[mbti_selected].item_]()_
